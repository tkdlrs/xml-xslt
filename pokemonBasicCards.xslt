...
<xsl:template match="/">
  ...
  <body>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1>Pokemon with XML and Bootstrap</h1>
             </div>
        </div>
...
<!--
    Help from 
     https://codereview.stackexchange.com/questions/58922/capitalize-words-in-xslt-1-0
 to capitalize the first letter of words.
 -->
